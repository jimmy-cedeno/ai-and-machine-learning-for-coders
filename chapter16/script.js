...
async function train(model, data) {
  ...
  console.log("trainXs shape:", trainXs.shape);
console.log("trainYs shape:", trainYs.shape);
  ...
  trainXs.slice([0, 0, 0, 0], [1, 28, 28, 1]).print();
...
async function run() {  
	...
	await train(model, data).then(history => {
